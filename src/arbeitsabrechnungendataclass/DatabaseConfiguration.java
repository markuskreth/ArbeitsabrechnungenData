...
public class DatabaseConfiguration {
	...
	private boolean checkTables() throws SQLException {
		...
		while (tables.next()) {
			log.trace("TABLE_SCHEM=" + tables.getString("TABLE_SCHEM") + "; TABLE_NAME=" + tables.getString("TABLE_NAME"));
			if("INFORMATION_SCHEMA".equals( tables.getString("TABLE_SCHEM")) == false) {
				exists = true;
			}
		}
		return exists;
	...
	private void createTables() throws SQLException {
		...
		stringBuilder.append("PRIMARY KEY (klienten_id));");
		...
		stringBuilder.append("PRIMARY KEY (angebote_id));");
		stm.executeQuery(stringBuilder.toString());
		...
		stringBuilder.append("PRIMARY KEY (einheiten_id));");
		stm.executeQuery(stringBuilder.toString());
		...
		stringBuilder.append("klienten_id int NOT NULL, ");
		stringBuilder.append("angebote_id int NOT NULL, ");
		stringBuilder.append("PRIMARY KEY (klienten_angebote_id), ");
		...
		stringBuilder.append("PRIMARY KEY (rechnungen_id));");
		stm.executeQuery(stringBuilder.toString());
		...
		stringBuilder.append("PRIMARY KEY (rechnungen_einheiten_id));");
		stm.executeQuery(stringBuilder.toString());
	}
}
